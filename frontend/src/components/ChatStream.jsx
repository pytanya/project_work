...
export default function ChatStream({ feed, busy = false, progressPhase = null, onJudgeLesson = null, judgeResult = null }) {
        ...
        <div key={m.id} className={`msg ${m.kind}`}>
          ...
          {m.kind === 'lesson' && (
            <div className="bubble agent">
              <LessonPanel text={m.text} topic={m.data?.topic} lesson={m.data?.lesson} sources={m.data?.sources || []} onJudge={onJudgeLesson} judgeResult={judgeResult} />
            </div>
          )}
          {m.kind === 'stream' && (
