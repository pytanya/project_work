...
SUBJECTS: List[str] = [
    ...
    "икт", "правоведение", "экология", "философия", "психология", "логика",
    "социология", "физическая культура", "основы безопасности жизнедеятельности",
]
...
def parse_doc_request(answer: str, num_pages: int) -> DocRequest:
    """Разбор ответа ученика: «12-15, Дроби», «стр. 12–15», «с 12 по 15»,
    «12,13,14», «урок 3 про дроби», «все».
