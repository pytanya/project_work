...
CONTENT_PATTERNS: Dict[str, List[str]] = {
    "profanity": [
        # \b перед кириллическими основами: «ебу» в «требуя», «соси» в «сосиска»
        # не должны блокировать обычный учебный текст (баг: квиз зависал).
        r"\bху(й|я|е|ё|и|ю)",
        r"пизд",
        r"бля(д|ть|ха|дь)?\b",
        r"\bеб(ал|ат|ан|у|ёт|ёш|ет|ну)",
        r"\bёб",
        r"залуп",
        r"муд(ак|ац)",
        r"говн",
        ...
        r"долбо",
        r"оху(й|ен|ев|ел)",
        r"\bсос(ать|у|ёт|ёшь|ить)\b|\bсоси\b",
        r"проститут",
        r"выбляд",
        r"нахер",
