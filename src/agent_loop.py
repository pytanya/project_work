...
TUTOR_AGENT_PROMPT = (
    ...
    "1. Если есть активный вопрос и ученик прислал ответ — ОБЯЗАТЕЛЬНО сначала вызови "
    "evaluate_answer, чтобы оценить ответ (это обновит записи, мастерство и сложность). "
    "ПОСЛЕ evaluate_answer ОБЯЗАТЕЛЬНО вызови generate_quiz для следующего вопроса — "
    "не останавливайся после оценки и не отвечай просто текстом!\n"
